  ...
  function start(){
    ...
    var htg = '';
        ...
        $.each(alltung,function(q,w){
            htg += `
            <a href="<?= base_url() ?>Review/resident/${org}/${w.id_warga}" class="item">
            <div class="detail">
            <div>
        ...
        $.each(lisAlt, function(q,t){
          ...
          bn += `       </tbody>
            ...
            <hr>
            <h3 class="ms-2 mr-2 text-end p-2"><span class="text-success" href="#">Total: Rp ${t.total_nominal.toLocaleString()}</span></h3>
            </div>
            </li>`
            ;
        });
