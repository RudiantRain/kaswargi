...
<div class="section mt-2">
    <a href="<?= base_url() ?>Review/allResident/<?= $org ?>">
    <div class="card">
        <ul class="listview no-line transparent flush simple-listview">
            <li>
                <div class="text-muted">Kode Organisasi</div>
                <strong class="text-success"><?= $org ?></strong>
            </li>
            <li>
                <div class="text-muted">Jumlah Keluarga</div>
                <div class="badge badge-success"><strong><?= count($warga) ?></strong></div>
            </li>
        </ul>
    </div>
    </a>
...
<div class="section full mt-4">
    ...
    <div class="card">
        <div id="chart"></div>
        <a href="<?= base_url() ?>Review/recap/<?= $org ?>" class="btn btn-outline-dark me-1 ms-1 mb-1">Lihat Semua</a>
    </div>
    <!-- * carousel single -->
...
<script type="text/javascript">
    ...
    function startGo(){
        ...
        Object.values(jskas.rekap_kas).forEach(kas=>{
            ...
            <a class="dropdown-item" href="<?= base_url() ?>Review/readByIdKas/${org}/${kas.id_kas}">
            - Rincian
            </a>
            <a class="dropdown-item" href="<?= base_url() ?>Review/printByIdKas/${org}/${kas.id_kas}">
            - Cetak
            </a>
            </div>
            </div>
