...
class Penjualan extends CI_Controller
{
    ...
    function store()
    {
        ...
        if (isset($_POST['filter'])) {
            ...
            $data = array(
                ...
                'customer' => $this->Model_customer->tampilkan_data(),
    ...
    {
        $cek['record'] = $this->Model_penjualan->cek_transaksi_edit($this->uri->segment(3));
        $this->template->load('template/template','penjualan/edit_penjualan', $cek);
    }


    function post_edit()
    {
        $id = $this->input->post('id_dtlpen');
        ...
        $data = array(
            ...
            'id_pembayaran' => $metode,
        );

        $this->Model_penjualan->edit_transaksi($data, $id);
        redirect('laporan');
    }
